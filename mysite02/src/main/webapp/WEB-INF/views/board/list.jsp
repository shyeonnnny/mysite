...
<body>
	<div id="container">
		...
		<div id="content">
			<div id="board">
				<form id="search_form" action="${pageContext.servletContext.contextPath }/board?ba=search&p=1" method="post">
				...
				<div class="pager">
					<ul class="row">
						<c:choose>
							...
							<c:otherwise>
								<li><a
									href="${pageContext.request.contextPath }/board?ba&p=${startPageNum -1 }">◀</a></li>
							</c:otherwise>
						</c:choose>
						...
						<c:forEach var="count" begin="${startPageNum }"
							...
							<c:choose>
								...
								<c:otherwise>
									<li><a
										href="${pageContext.request.contextPath }/board?ba&p=${count }">${count }</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						...
						<c:choose>
							...
							<c:otherwise>
								<li><a
									href="${pageContext.request.contextPath }/board?ba&p=${endPageNum + 1 }">▶</a></li>
							</c:otherwise>
						</c:choose>
					</ul>
				</div>
